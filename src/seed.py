...
SEED_CODES = {
    "magical-world-bookshelf": "HP-BOOKSHELF",
    "glasses-case": "HH-GLASSES",
    "scrunchie-holder": "HH-SCRUNCHIE",
    "lip-balm-holder-set": "HH-LIPBALM",
    "magic-bookshelf-decor": "HP-WIZARD",
    "minas-tirith": "LOTR-MINAS",
    "funny-desk-signs": "HH-SIGNS",
    "articulated-dragon": "TOY-DRAGON",
    "dragon-egg": "TOY-EGG",
    "dragon-egg-set": "TOY-SET",
    "custom-cake-topper": "HH-TOPPER",
    "bear-keychain": "HH-BEAR",
    "oak-coaster-set": "HH-COASTERS",
    "cutting-board": "HH-BOARD",
    "name-plaque": "HH-PLAQUE",
    "family-name-sign": "HH-SIGN",
}
